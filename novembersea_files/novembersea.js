...
{return false;}
function onPageLoad()
{loadMozillaCSS('novembersea_files/novemberseaMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('novembersea_files','shapeimage_3','0');applyEffects()}
