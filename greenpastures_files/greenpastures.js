...
{return false;}
function onPageLoad()
{loadMozillaCSS('greenpastures_files/greenpasturesMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('greenpastures_files','shapeimage_3','0');applyEffects()}
