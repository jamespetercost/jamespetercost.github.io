...
{return false;}
function onPageLoad()
{loadMozillaCSS('onefoldone_files/onefoldoneMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('onefoldone_files','shapeimage_3','0');applyEffects()}
