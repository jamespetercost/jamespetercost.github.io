...
{return false;}
function onPageLoad()
{loadMozillaCSS('endofthestorm_files/endofthestormMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('endofthestorm_files','shapeimage_3','0');applyEffects()}
