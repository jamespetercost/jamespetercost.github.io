...
{return false;}
function onPageLoad()
{loadMozillaCSS('firstlightofday_files/firstlightofdayMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('firstlightofday_files','shapeimage_3','0');applyEffects()}
