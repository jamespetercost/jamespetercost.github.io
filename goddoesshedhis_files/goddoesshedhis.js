...
{return false;}
function onPageLoad()
{loadMozillaCSS('goddoesshedhis_files/goddoesshedhisMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('goddoesshedhis_files','shapeimage_3','0');applyEffects()}
