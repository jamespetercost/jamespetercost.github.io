...
{return false;}
function onPageLoad()
{loadMozillaCSS('sweetcalm_files/sweetcalmMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('sweetcalm_files','shapeimage_3','0');applyEffects()}
