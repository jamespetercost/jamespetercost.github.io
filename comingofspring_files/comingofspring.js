...
{return false;}
function onPageLoad()
{loadMozillaCSS('comingofspring_files/comingofspringMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('comingofspring_files','shapeimage_3','0');applyEffects()}
