...
{return false;}
function onPageLoad()
{loadMozillaCSS('sunriseclearing_files/sunriseclearingMoz.css')
detectBrowser();Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('sunriseclearing_files','shapeimage_3','0');applyEffects()}
